...
final class CustomArchiveButton: UIButton {
...
private extension CustomArchiveButton {
    ...
    func configure() {
        ...
        icon.image = Resources.Images.archivebox?.withRenderingMode(.alwaysTemplate)
